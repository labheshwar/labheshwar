...
## 💫 About Me:
🚀 Software Engineer @ Paysys Labs<br>🏦 Building fintech & payments platforms<br>☕ Java, Spring Boot & React.js<br>⭐ 6-star HackerRank Problem Solver<br>📄 Blogger<br>🔭 Astronomy and Astrophysics Enthusiast<br>

Full-stack engineer working across Java/Spring Boot backends and React.js/TypeScript frontends. Currently leading, from the tech side, the ground-up build of a merchant-acquiring and QR/RTP payment platform — covering merchant onboarding, terminal and payment processing, and notification systems, deployed on Docker and Kubernetes with PostgreSQL.

I'm a firm believer in collaboration and enjoy contributing to a team's success — through code reviews, mentoring, and sharing what I learn along the way, whether that's through blogging or just a good conversation about a tricky bug.
